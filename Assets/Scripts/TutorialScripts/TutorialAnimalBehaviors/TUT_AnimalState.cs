...
public class TUT_AnimalState
{
    public static int timesKicked = 0;

    [Header("AnimalVars")]
    protected sbyte lifes;
    public sbyte Lifes { get => lifes; }
    public static bool isInsideCorral = true;
    ...
    protected TUT_AnimalState nextState;
    ...
    public TUT_AnimalState Process()
    {
    ...
    public TUT_AnimalState(sbyte _lifes, float _baseMovSpeed, float _shadowPosOffset, float _physicalCorralLimit, float _xToppedOffMove, float[] _yToppedOffMoveMinMax, float[] _corralLimits, bool _dead,
    ...
    public void AnimalToppedOff()
    {
        ...
        if (kicked == false)
        {
            ...
            nextState = new TUT_AnimalToppedOff(lifes, baseMovementSpeed, shadowPosOffset, physicCorralLimit, xToppedOffMove, yToppedOffMoveMinMax, corralLimits, dead,
    ...
    {
        PlayRandomSound();
        nextState = new TUT_AnimalKicked(lifes, baseMovementSpeed, shadowPosOffset, physicCorralLimit, xToppedOffMove, yToppedOffMoveMinMax, corralLimits, dead,
                animal, animalShadow, anim, audioSource, audioClips);
        stage = EVENT.EXIT;
    }
