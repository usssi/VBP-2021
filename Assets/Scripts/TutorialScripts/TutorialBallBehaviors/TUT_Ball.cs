...
public class TUT_Ball
{
    public static bool isInTutorial = true;
    public static int timesRecibida = 0;
    ...
    protected TUT_ChadMovement chadScript;

    protected BallSoundsManager ballSoundsManager;
    ...
    public TUT_Ball(GameObject _ball, Animator _ballAnim, Transform _player, GameObject _redCross, GameObject _greenCircle, GameObject _sagashiGObj, TUT_ChadMovement _chadScript
    ...
    protected void CheckIfBallHasTouchedGround(float offset, TUT_Ball ballNextState)
    {
