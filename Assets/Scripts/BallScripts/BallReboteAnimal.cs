...
public class BallReboteAnimal : Ball
{
    private Vector2 wallReboundPos;
    private Vector2 animalReboundDir;
    //private float animalReboundSpeed;



    public BallReboteAnimal(GameObject _ball, Animator _ballAnim, Transform _player, GameObject _redCross, GameObject _greenCircle, GameObject _sagashiGObj, ChadMovement _chadScript
    ...
    {
        base.Enter();
        soundsManager.PlaySound("reboteAnimal");
    ...
    protected override void Update()
    {
        ...
        if(ball.transform.position.x >= wallReboundPos.x)
        {
            ...
            nextState = new BallRebotePared(ball, ballAnim, player, redCross, greenCircle, sagashiGameObject, chadScript
